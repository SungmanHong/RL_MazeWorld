...
class sarsa:
    ...
    def learn(self, s, a, r, s_):
        ...
        if s_ != 'terminal':
            ...
            q_target = self.q_table.loc[s, a] + self.lr * (r + self.gamma * self.q_table.loc[s_, a_] - self.q_table.loc[s, a]); 
        else:
            q_target = self.lr * r - (1 - self.lr) * self.q_table.loc[s, a] # next state is terminal
